...
SAMPLES: tuple[Sample, ...] = (
    ...
    Sample("adaptive_intake", "Val, no sé qué necesito", "adaptive_intake_start"),
    Sample("adaptive_intake", "Val, ayúdame a empezar", "adaptive_intake_start"),
    Sample("adaptive_intake", "Val, estoy perdida", "adaptive_intake_start"),
    Sample("adaptive_intake", "Val, tengo demasiadas cosas", "adaptive_intake_start"),
    Sample("adaptive_intake", "Val, no sé por dónde empezar", "adaptive_intake_start"),
    Sample("adaptive_intake", "quiero organizar mi día", "adaptive_intake_start"),
    Sample("adaptive_intake", "todo me sirve", "llm_fallback", "orphan broad reply stays fallback without adaptive state"),
    Sample("adaptive_intake", "todo me sirve", "adaptive_intake_recommendation", "adaptive recommendation pending state", {"type": "adaptive_intake_recommendation"}),
    Sample("adaptive_intake", "trabajo", "llm_fallback", "orphan short domain stays fallback without adaptive state"),
    Sample("adaptive_intake", "trabajo", "adaptive_intake_domain", "adaptive domain pending state", {"type": "adaptive_intake_domain"}),
    Sample("adaptive_intake", "soy cajera", "adaptive_intake_followup"),
    Sample("adaptive_intake", "soy cajera en una tienda de departamento", "adaptive_intake_followup"),
    Sample("adaptive_intake", "atiendo caja en una tienda", "adaptive_intake_followup"),
    Sample("adaptive_intake", "trabajo en retail", "adaptive_intake_followup"),
    Sample("adaptive_intake", "horarios", "llm_fallback", "orphan short recommendation reply stays fallback"),
    Sample("adaptive_intake", "horarios", "adaptive_intake_recommendation", "adaptive recommendation pending state", {"type": "adaptive_intake_recommendation"}),
    Sample("adaptive_intake", "pendientes", "llm_fallback", "orphan short recommendation reply stays fallback"),
    Sample("adaptive_intake", "pendientes", "adaptive_intake_recommendation", "adaptive recommendation pending state", {"type": "adaptive_intake_recommendation"}),
    Sample("adaptive_intake", "recordatorios", "llm_fallback", "orphan short recommendation reply stays fallback"),
    Sample("adaptive_intake", "recordatorios", "adaptive_intake_recommendation", "adaptive recommendation pending state", {"type": "adaptive_intake_recommendation"}),
    Sample("adaptive_intake", "dinero y pagos", "adaptive_intake_recommendation", "adaptive recommendation pending state", {"type": "adaptive_intake_recommendation"}),
    Sample("adaptive_intake", "cansancio después del turno", "adaptive_intake_recommendation", "adaptive recommendation pending state", {"type": "adaptive_intake_recommendation"}),
    Sample("adaptive_intake", "tengo clientes que perseguir", "adaptive_intake_domain"),
    Sample("adaptive_intake", "tengo papeles regados", "adaptive_intake_domain"),
    Sample("adaptive_intake", "ideas para un libro", "adaptive_intake_domain"),

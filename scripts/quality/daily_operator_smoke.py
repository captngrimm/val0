...
def main():
    ...
    assert_false("dame detalles del 1" in compact_text, "compact does not advertise drilldown before implemented")
    assert_true("Val, dame el resumen completo de hoy" in compact_text, "compact full-summary hint")
    ...
    assert_true("Val, dame el resumen completo de hoy" in compact_empty, "empty compact full-summary hint")

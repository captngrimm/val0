...
def test_reminder_management_routes_and_copy() -> None:
    ...
    assert_contains(handler, "solo puedo eliminarlo y crear uno nuevo", "honest edit fallback")
...
def test_task_query_creation_delete_schedule_completion_routes() -> None:
    ...
    assert_contains(delete_handler, "¿Quieres marcar la tarea", "task delete asks safe clarification")

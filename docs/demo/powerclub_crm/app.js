...
const KPI_EXPLANATIONS = {
  ...
  conversionRate: {
    ...
    formula: "Tasa de conversión = ventas cerradas / base filtrada.",
  ...
  branchConversion: {
    ...
    formula: "Conversión por sucursal = ventas de una sucursal / registros de esa sucursal.",
  ...
  sourceQuality: {
    ...
    formula: "Calidad del canal = ranking de canales por conversion, usando volumen como desempate.",
  ...
  stuckOpportunities: {
    ...
    formula: "Oportunidades estancadas = registros abiertos marcados como trabados por reglas demo.",

...
| Ask about contradiction / weirdness | `Val, hay algo raro o contradictorio en el Caso Finca?` | `Val, ves algo raro?`; `Val, algo no cuadra?` with active case context | Contradiction/weirdness Q&A answer, framed as items to review | Design doc includes risk; current smoke coverage appears thinner than core demo phrases | Add smoke coverage before demoing this live | Frame as “cosas que revisaría con Nora”; no conclusions | BLOCKER risk |

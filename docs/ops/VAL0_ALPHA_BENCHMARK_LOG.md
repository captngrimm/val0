...
A-028B is sealed. Recommended next: live Telegram retest timeline event draft preview, then A-028C Timeline Event Storage Spike / Fixture Storage or A-028C Confirmed Save Skeleton if storage risk is acceptable.

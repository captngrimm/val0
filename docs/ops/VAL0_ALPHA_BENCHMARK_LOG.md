...
NIGHT-RUNNER-16 is sealed. Recommended next: ValPrime checkpoint, then NIGHT-RUNNER-17 Bedtime Workflow Packet v2. This starts packaging the actual bedtime workflow; still no runtime bot/core behavior, no client data, no restarts, no live DB writes, no commits unless explicitly approved.

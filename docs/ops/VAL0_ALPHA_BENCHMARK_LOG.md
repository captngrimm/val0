...
A-028C is sealed. Recommended next: A-028D Timeline Event Confirmation Handler Fixture-Only, still using temp/fixture storage first; do not enable live client persistence yet.

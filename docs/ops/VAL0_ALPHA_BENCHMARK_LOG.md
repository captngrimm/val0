...
A-028D is sealed. Recommended next: A-028E Live Persistence Decision / SQLite-vs-JSON Guardrail Design, or A-028E Timeline Read From Fixture Store if continuing test-mode loop.

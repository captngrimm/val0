...
A-026B is sealed. Recommended next: restart Val0 runtime, live Telegram retest the document-priority alias, then decide between Caso Finca timeline/events v1 or folder/case runtime v1.

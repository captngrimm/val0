...
A-028H is sealed. Recommended next: ValPrime checkpoint, then A-028I Timeline SQLite Export / Operator Diagnostic, still temp DB only; after that plan reviewed live migration/enablement.

...
A-028G is sealed. Recommended next: ValPrime checkpoint, then A-028H Timeline Read From SQLite Temp Store, still fixture-only. Do not enable live Telegram persistence yet.

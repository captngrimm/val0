...
A-027D is sealed. Recommended next: restart Val0 runtime, live Telegram retest 'qué falta ordenar por fecha?', then decide between timeline event registration design or folder/case runtime v1.

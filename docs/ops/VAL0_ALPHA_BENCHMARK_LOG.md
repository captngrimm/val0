...
A-028F is sealed. Recommended next: A-028G Timeline Event SQLite Confirmation Wiring in Fixture Mode, then separate reviewed live migration/enablement lane. Still do not enable live Telegram persistence.

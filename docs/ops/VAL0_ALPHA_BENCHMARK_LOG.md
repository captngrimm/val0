...
A-028 is sealed. Recommended next: A-028B Timeline Event Draft Parser + Confirmation Skeleton, or A-028B storage spike/fixture-only if storage risk feels high.

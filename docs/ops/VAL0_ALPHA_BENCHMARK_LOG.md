...
| NIGHT-RUNNER-06 | Branch-only Codex Attempt Dry-Run | 1-2 h | 2026-06-05 00:26 | 2026-06-05 00:34 | 0.15 h | `f8e391e` | PASS | Human outcome: Night Runner can now validate a branch-only Codex attempt packet, verify guardrails, find the local Codex binary, build the would-run command, and write a morning-style report without executing Codex or changing live/runtime state. Codex execution: no. Commits allowed: no. Restarts allowed: no. Live writes allowed: no. Protected live files unchanged and unstaged. |
| NIGHT-RUNNER-07 | Branch-only Codex No-op Invocation | 1-2 h | 2026-06-05 00:37 | 2026-06-05 00:45 | 0.15 h | `a93f367` | PASS | Human outcome: Night Runner can now perform a guarded branch-only Codex no-op invocation, capture output/exit code, write a report under tmp/night_runner, and verify no repo/live-client mutation occurred. Codex actually invoked: yes. Command shape: codex exec -C /opt/val0 -s read-only --ephemeral -- <noop prompt>. Final Codex exit code: 0. Protected live file hashes unchanged, git head/status unchanged after invocation, no staged files, no commits/restarts/live writes allowed. |
| NIGHT-RUNNER-08 | Branch-only Codex Read-only Planning Packet | 1-2 h | 2026-06-05 00:47 | 2026-06-05 01:00 | 0.2 h | `081859b` | PASS | Human outcome: Night Runner can now invoke Codex in read-only planning mode, capture the plan/report, and verify no repo or protected live-client mutation occurred. Codex actually invoked: yes. Command shape: codex exec -C /opt/val0 -s read-only --ephemeral -o tmp/night_runner/codex_readonly_plan_report_last_message.txt -- <planning prompt>. Final Codex exit code: 0. Codex recommended NIGHT-RUNNER-09 Branch-only Documentation Diagnostic. Protected live file hashes unchanged, git head/status unchanged after invocation, no staged files, no file edits/commits/restarts/live writes allowed. |
| NIGHT-RUNNER-09 | Branch-only Documentation Diagnostic | 1-2 h | 2026-06-05 01:02 | 2026-06-05 01:05 | 0.05 h | `f3ca0b6` | PASS | Human outcome: NIGHT-RUNNER-09 completed the first controlled file-edit lane. Codex created one docs-only artifact documenting the documentation-diagnostic pattern and guardrails. Edited file: docs/ops/NIGHT_RUNNER_DOCS_DIAGNOSTIC.md. No Python/runtime files were edited, protected live file hashes were unchanged, no protected files were staged/reset/discarded, and no staged files remained. |
| NIGHT-RUNNER-10 | Branch-only Tiny Docs Patch With Smoke | 1-2 h | 2026-06-05 01:08 | 2026-06-05 01:10 | 0.05 h | `995812b` | PASS | Human outcome: NIGHT-RUNNER-10 proved a tiny docs-only patch plus focused smoke can be added and verified without touching runtime code or protected live-client data. Codex edited docs + smoke only. Edited files: docs/ops/NIGHT_RUNNER_DOCS_DIAGNOSTIC.md and scripts/quality/night_runner_docs_diagnostic_smoke.py. Smoke passed, client isolation audit passed, git diff --check passed, protected live file hashes unchanged, and no staged files remained. |
| NIGHT-RUNNER-11 | Branch-only Tiny Non-runtime Script Patch Candidate | 1-2 h | 2026-06-05 01:13 | 2026-06-05 01:17 | 0.1 h | `6454a5b` | PASS | Human outcome: Codex created one tiny non-runtime diagnostic plus a focused smoke. The diagnostic reports Night Runner readiness, existing Codex bridge/no-op/read-only planning artifacts, protected live-file git status, and the safe next lane: NIGHT-RUNNER-12 Branch-only Tiny Safe Task Runner Dry-Run. Runtime files touched: no. Protected live files touched: no. Staged files: none. Compile, smoke, docs diagnostic smoke, client isolation audit, and git diff --check passed. |
| NIGHT-RUNNER-12 | Branch-only Tiny Safe Task Runner Dry-Run | 1-2 h | 2026-06-05 01:20 | 2026-06-05 01:26 | 0.1 h | `b6f5d1a` | PASS | Human outcome: Added a tiny dry-run task wrapper that validates a safe packet, refuses unsafe settings, allows only a small diagnostics allowlist, writes a report under tmp/night_runner, and never allows file edits, commits, restarts, or live writes. Decision: PASS_TINY_TASK_DRY_RUN_READY. Tests run by tiny task runner: readiness summary smoke, docs diagnostic smoke, client isolation audit, git diff --check. Runtime files touched: no. Protected live files touched: no. Staged files: none. |
| NIGHT-RUNNER-13 | Branch-only Tiny Safe Task Runner Execution Guard | 1-2 h | 2026-06-05 01:28 | 2026-06-05 01:33 | 0.1 h | `b00dca5` | PASS | Human outcome: Night Runner can now run a tiny allowlisted diagnostic packet, capture exit codes, write a report, and verify safety before/after execution. Decision: PASS_TINY_TASK_EXECUTION_GUARD. Commands run: readiness summary smoke, docs diagnostic smoke, client isolation audit, git diff --check. File edits allowed: no. Commits/restarts/live writes allowed: no. Runtime files touched: no. Protected live files touched: no. Staged files: none. |
| NIGHT-RUNNER-14 | Branch-only Tiny Reported Patch Guard | 1-2 h | 2026-06-05 01:36 | 2026-06-05 01:43 | 0.15 h | `b1562d1` | PASS | Human outcome: Night Runner now supports a tiny reported-patch guard: it records changed files, checks them against allowed_files, refuses forbidden/runtime changes, runs only allowlisted diagnostics, and writes a report. Decision: PASS_TINY_REPORTED_PATCH_GUARD. Changed-file proof: allowed changed files pass; forbidden/runtime/protected staged simulations refuse; protected dirty-but-forbidden files are accepted. Runtime files touched: no. Protected live files touched: no. Staged files: none. No commits/restarts/live writes allowed by runner. |
| NIGHT-RUNNER-15 | Branch-only Tiny Non-runtime Patch Attempt | 1-2 h | 2026-06-05 01:45 | 2026-06-05 01:49 | 0.1 h | `597f6a4` | PASS | Human outcome: Added a useful non-runtime readiness improvement under the reported-patch guard. night_runner_readiness_summary.py now prints a Sleep Mode Ladder showing Night Runner capabilities from Codex bridge discovery through reported patch guard, plus the next step. Changed files matched allowed files. Runtime files touched: no. Protected live files touched: no. Staged files: none. Tests passed: readiness summary smoke, reported patch guard smoke, execution guard smoke, tiny task dry-run smoke, docs diagnostic smoke, client isolation audit, git diff --check. |
| NIGHT-RUNNER-16 | Branch-only Tiny Non-runtime Patch Review | 1-2 h | 2026-06-05 01:51 | 2026-06-05 01:57 | 0.1 h | `6dca421` | PASS | Human outcome: Added a non-runtime Night Runner patch review diagnostic so Boss can see what the first useful non-runtime patch proved, what remains forbidden, current changed-file status, protected live-data status, and the next bedtime-workflow lane. Technical change: added Night Runner Patch Review diagnostic and smoke. No runtime behavior, no bot.py/core changes, no client-data contents printed, no secrets printed, protected live files unchanged, and no staged files remained. |
| NIGHT-RUNNER-17 | Bedtime Workflow Packet v2 | 1-3 h | 2026-06-05 01:59 | 2026-06-05 02:03 | 0.1 h | `d714034` | PASS | Human outcome: Added Bedtime Workflow v2 packaging so Boss has a clear manual path: choose one scoped non-runtime task, list allowed/forbidden files, run guarded diagnostics, review a morning report, then approve/discard/continue/ask ValPrime. Technical change: added operator workflow doc, v2 sample packet, and smoke validating guardrails. No runtime behavior, no bot.py/core changes, no client data, no restarts, no live DB writes, and no commits by runner. |
| NIGHT-RUNNER-18 | Manual Bedtime Trial | 1-2 h | 2026-06-05 02:05 | 2026-06-05 02:12 | 0.15 h | `4b5d228` | PASS | Human outcome: Ran the Bedtime Workflow v2 end-to-end manually through a guarded wrapper. It validates the packet, runs only allowlisted safe diagnostics, writes the report, and prints a morning-review summary without touching runtime/client/live data. Decision: PASS_BEDTIME_TRIAL_READY. Report path: tmp/night_runner/bedtime_v2_report.md. Morning review options: approve, discard, continue, ask_valprime. Runtime files touched: no. Protected live files touched: no. Staged files: none. Commits/restarts/live writes allowed: no. |
| NIGHT-RUNNER-19 | Bedtime Report Review Polish | 1-2 h | 2026-06-05 02:14 | 2026-06-05 02:19 | 0.1 h | `32a4eab` | PASS | Human outcome: Polished the bedtime report into a clearer morning-review artifact. Boss can now quickly see the decision, task, tests, changed files, safety status, protected live-data status, review options, and recommended next step. Decision: PASS_BEDTIME_TRIAL_READY. Report path: tmp/night_runner/bedtime_v2_report.md. Morning review options: approve, discard, continue, ask_valprime. Runtime files touched: no. Protected live files touched: no. Staged files: none. No Codex execution, commits, restarts, runtime edits, live writes, or client-data edits. |
| NIGHT-RUNNER-20 | First Real Manual Overnight Trial | 1-2 h | 2026-06-05 02:21 | 2026-06-05 02:30 | 0.15 h | `22cb55a` | PASS | Human outcome: Added manual overnight trial mode to the bedtime trial wrapper. It writes tmp/night_runner/bedtime_v2_report.md and tmp/night_runner/manual_overnight_trial_report.md, prints a concise morning summary with decision, test counts, changed files, safety status, review options, and next lane. Decision: PASS_MANUAL_OVERNIGHT_TRIAL. Runtime files touched: no. Protected live files touched: no. Staged files: none. No Codex execution, commits, restarts, runtime edits, live writes, or client-data edits. |
| NIGHT-RUNNER-21 | First Tiny Useful Overnight Candidate | 1-2 h | 2026-06-05 02:32 | 2026-06-05 02:38 | 0.1 h | `208a862` | PASS | Human outcome: Added a small read-only operator diagnostic: Night Runner Overnight Candidate Summary. It reports branch/head, git status summary, protected live-data status from git metadata only, current sleep-mode capabilities, still-forbidden actions, and next milestone. Recommendation: Safe to continue with non-runtime overnight candidates only. Manual overnight assumptions preserved: non-runtime, no Codex execution, no commits, no restarts, no live writes, no client data reads. Runtime files touched: no. Protected live files touched: no. Staged files: none. |
...
NIGHT-RUNNER-21 is sealed. Recommended next: ValPrime checkpoint, then NIGHT-RUNNER-22 Tiny Useful Candidate With Reported Patch Review. Still no runtime bot/core behavior, no client data, no restarts, no live DB writes, no commits unless explicitly approved.
